...
extension SelfShape {
    static func determinationTransform() -> CATransform3D {
...
#Preview(body: {
    VStack {
        ...
        //        MyIconsdasa()
        ShapeHomeRepresentable(shape: .determination, weight: .light)
        ShapeHomeRepresentable(shape: .determination, weight: .dark)
    }
